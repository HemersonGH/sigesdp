...
CREATE TABLE IF NOT EXISTS sigesdp.professor (
    ...
    CONSTRAINT fk_id_area_conhecimento FOREIGN KEY(id_area_conhecimento) REFERENCES sigesdp.area_conhecimento (id)
);
...
COMMENT ON COLUMN sigesdp.professor.id_area_conhecimento IS 'Identificador da área de conhecimento do professor.';

        ...
        v-tooltip(
          ...
          template(
            ...
            v-btn.v-btn--simple.no-margin(
              ...
              slot='activator'
              icon
              @click.stop='viewDetailsIniciacaoCientifica(item)'
            )
              v-icon.no-margin(
                color='#707070'
              ) mdi-eye
...
<script>
export default {
  name: 'ListagemIniciacaoCientifica',
  ...
  methods: {
    viewDetailsIniciacaoCientifica (iniciacaoCientifica) {
      this.$emit('openModalDetalhesIniciacaoCientifica', iniciacaoCientifica)
    }
  }
}
</script>
